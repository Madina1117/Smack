...
import com.example.madinaochilova.smack.Adapters.MessageAdapter
        ...
        if (App.prefs.isLoggedIn){
            runOnUiThread {
                ...
                if (channelId==selectedChannel?.id){
                    ...
                    val userAvatartColor = args[5] as String
                    val id = args[6] as String
                    val timeStamp = args[7] as String

                    val newMessage = Message(msgBody, userName, channelId, userAvatar, userAvatartColor, id, timeStamp)
